					...
					<div class="cart_container">
								...
								<li class="cart_item clearfix">
									...
									<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
										<div class="cart_item_name cart_info_col">
											...
											<div class="cart_item_text">Tas Rajut Kerajinan Tangan</div>
										</div>
										<div class="cart_item_color cart_info_col">
											<div class="cart_item_title">Warna</div>
											<div class="cart_item_text"><span style="background-color:#584448;"></span>-</div>
										</div>
						...
						<div class="order_total">
							<div class="order_total_content text-md-right">
								...
								<div class="order_total_amount">Rp 100.000</div>
							</div>
						</div>

						<div class="cart_buttons">
							<button type="button" class="button cart_button_checkout"><a href="product.html">Kembali</button>
							<button type="button" class="button cart_button_checkout"><a href="#">Bayar</a></button>
						</div>
					</div>
				</div>
			</div>
