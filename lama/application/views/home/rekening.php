				...
				<div class="col-lg-10 offset-lg-1">
					<div class="cart_container">
								...
								<li class="cart_item clearfix">
									...
									<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
										...
										<div class="cart_item_quantity cart_info_col">
											...
											<?php foreach ($this->cart->contents() as $items): ?>
											 <?php echo form_hidden($i.'[rowid]', $items['rowid']); ?>
											<div class="cart_item_text"><?php echo form_input(array('name' => $i.'[qty]', 'value' => $items['qty'], 'maxlength' => '3', 'size' => '5')); ?></div>
											<?php $i++; ?>
											<?php endforeach; ?>
										</div>
						...
						<div class="cart_buttons">
							...
							<button type="button" class="button cart_button_checkout"><a href="<?php echo base_url()?>Keranjang/rekening">Bayar</a></button>
						</div>
					</div>
				</div>
			</div>
