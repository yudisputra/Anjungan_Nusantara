			...
			<div class="row">
				<div class="col-lg-10 offset-lg-1">
					<div class="cart_container">
						<div class="cart_title">Riwayat Pemesanan</div>
								...
								<li class="cart_item clearfix">
									...
									<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
										<div class="cart_item_name cart_info_col">
											...
											<div class="cart_item_text"><?php echo $key->tanggal_pembelian ?></div>
										</div>
										<div class="cart_item_color cart_info_col">
											<div class="cart_item_title">Status Pembelian</div>
											<div class="cart_item_text"><?php echo $key->status_pembelian ?></div>
										</div>
										<div class="cart_item_quantity cart_info_col">
											<div class="cart_item_title">Total Pembayaran</div>
											<div class="cart_item_text">Rp <?php echo $key->total_pembayaran ?></div>
                                        </div>
                                        <div class="cart_item_quantity cart_info_col">
                                        <div class="cart_item_text"><button type="button" class="button cart_button_checkout"><a href="<?php echo base_url()?>User/upload/<?php echo $key->id_pembelian ?>">Upload Bukti</a></button></div>
										</div>
									</div>
                                </li>
                                <?php } ?>
