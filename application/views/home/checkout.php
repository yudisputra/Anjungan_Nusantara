...
<link rel="stylesheet" type="text/css" href="<?php echo site_url()?>assets/homepage_lib/styles/contact_styles.css">
<link rel="stylesheet" type="text/css" href="<?php echo site_url()?>assets/homepage_lib/styles/contact_responsive.css">
...
<script src="<?php echo site_url()?>assets/homepage_lib/https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyCIwF204lFZg1y4kPSIhKaHEXMLYxxuMhA"></script>
<script src="<?php echo site_url()?>assets/homepage_lib/js/contact_custom.js"></script>
</body>
