...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>assets_global/css/profile-v2.css">
    ...
    <?php $this->load->view('penjual/components/'.$headers); ?>

    <?php $this->load->view('penjual/layouts/nav_sidebar_view'); ?>

    <!-- Page -->
    <div class="page">
      <?php $this->load->view('penjual/contents/'.$contents); ?>
    </div>
    <!-- End Page -->
    ...
    <?php $this->load->view('penjual/components/'.$footers); ?>
