...
<!-- 							<div class="product_item discount">
							...
							<!-- Product Item -->
								<li>
									...
									<div class="product_border"></div>
									<div class="product_image d-flex flex-column align-items-center justify-content-center"><a href="<?= base_url('Welcome/detail_produk/'.$value->produk_id)  ?>"><img src="<?= base_url('assets/foto/foto_produk/'.$value->produk_foto_depan) ?>" height="150px" width='150px' alt=""></a></div>
									<div class="product_content">
										<div class="product_price"><?= "Rp. ". number_format($value->produk_harga_jual, 2, ".", ".") ?></div>
										<div class="product_name"><div><a href="#" tabindex="0"><?= $value->produk_nama  ?></a></div></div>
									</div>
									<div class="product_fav"><i class="fas fa-heart"></i></div>
	<!-- 								<ul class="product_marks">
										<li class="product_mark product_discount">-25%</li>
