...
<html>
	<head>
		...
		<!-- STYLE CSS -->
		<link rel="stylesheet" href="<?php echo base_url('assets/register/register_new/css/style.css')?>">
		<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.js"></script>
		<script src="<?php echo base_url()?>assets/register/cleave/cleave.min.js"></script>
    	<script src="<?php echo base_url()?>assets/register/cleave/cleave.js"></script>

	</head>

	<body>

		<div class="wrapper" style="background-image: url('<?php echo base_url('assets/register/register_new/images/kabuabu (1).jpg');?>');">
			
			<div class="inner">
				<div class="image-holder">
					<img src="<?php echo base_url('assets/register/register_new/images/login-ui-ux-design-concept-illustration_78200-431_(2).jpg')?>" alt="">
				</div> 
	...
	<script src="<?php echo base_url()?>assets/register/js/vendor.js"></script>
    <script src="<?php echo base_url()?>assets/register/js/app.js"></script>
