...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <title>Maintenance | Remark Material Admin Template</title>
    ...
    <link rel="stylesheet" href="<?php echo base_url()?>assets_global/vendor/waves/waves.css">
        <link rel="stylesheet" href="<?php echo base_url()?>assets/examples/css/pages/maintenance.css">
    ...
    <!--[if lt IE 9]>
    <script src="<?php echo base_url()?>assets_global/vendor/html5shiv/html5shiv.min.js"></script>
    <![endif]-->
    
    <!--[if lt IE 10]>
    <script src="<?php echo base_url()?>assets_global/vendor/media-match/media.match.min.js"></script>
    <script src="<?php echo base_url()?>assets_global/vendor/respond/respond.min.js"></script>
    <![endif]-->
